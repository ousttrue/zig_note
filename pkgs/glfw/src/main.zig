...
const GLFWdropfun = fn (window: ?*GLFWwindow, path_count: c_int, paths: ?*?[*]const u8) callconv(.C) void;
...
pub extern "c" fn glfwGetProcAddress(procname: ?[*]const u8) *const GLFWglproc;
