...
const Shape = @import("./gizmo_shape.zig").Shape;
...
pub const GizmoVertexBuffer = struct {
    ...
    pub fn addTriangle(self: *Self, bone: i32, t: zigla.ray_intersection.Triangle, color: zigla.Vec4) void {
        const v10 = @"-"(t.v0, t.v1);
        const v12 = @"-"(t.v2, t.v1);
        const n = v10.cross(v12).normalized();
        const i1 = self.addVertex(bone, t.v1, n, color);
        const i0 = self.addVertex(bone, t.v0, n, color);
        const i2 = self.addVertex(bone, t.v2, n, color);
    ...
    // pub fn addShape(self: *Self, bone: i32, shape: Shape)
    // {
